...
bench(
  "SIMD String Head-to-Head Field Plain",
  benchFieldPlainSIMD,
  1_000_000,
  plainBytes,
);
...
bench(
  "SIMD String Head-to-Head Field Plain (SWAR)",
  benchFieldPlainSWAR,
  1_000_000,
  plainBytes,
);
...
bench(
  "SIMD String Head-to-Head Direct Plain",
  benchDirectPlainSIMD,
  1_000_000,
  plainBytes,
);
...
bench(
  "SIMD String Head-to-Head Direct Plain (SWAR)",
  benchDirectPlainSWAR,
  1_000_000,
  plainBytes,
);
...
bench(
  "SIMD String Head-to-Head Field Escaped",
  benchFieldEscapedSIMD,
  1_000_000,
  escapedBytes,
);
...
bench(
  "SIMD String Head-to-Head Field Escaped (SWAR)",
  benchFieldEscapedSWAR,
  1_000_000,
  escapedBytes,
);
...
bench(
  "SIMD String Head-to-Head Direct Escaped",
  benchDirectEscapedSIMD,
  1_000_000,
  escapedBytes,
);
...
bench(
  "SIMD String Head-to-Head Direct Escaped (SWAR)",
  benchDirectEscapedSWAR,
  1_000_000,
  escapedBytes,
);
...
bench(
  "SIMD String Head-to-Head Field Plain (5mb)",
  benchLargeFieldPlainSIMD,
  500,
  largePlainBytes,
);
...
bench(
  "SIMD String Head-to-Head Field Plain (5mb) (SWAR)",
  benchLargeFieldPlainSWAR,
  500,
  largePlainBytes,
);
...
bench(
  "SIMD String Head-to-Head Field Escaped (5mb)",
  benchLargeFieldEscapedSIMD,
  500,
  largeEscapedBytes,
);
...
bench(
  "SIMD String Head-to-Head Field Escaped (5mb) (SWAR)",
  benchLargeFieldEscapedSWAR,
  500,
  largeEscapedBytes,
);
