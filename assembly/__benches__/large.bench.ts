...
function deserializeNullableStringField(srcStart: usize, srcEnd: usize, fieldPtr: usize): usize {
  ...
  return deserializeStringField_SWAR<string | null>(srcStart, srcEnd, fieldPtr);
}
...
class RepoOwner {
  ...
  //     do {
  //       if (load<u64>(srcStart, 0) != 31244186273579131 || load<u64>(srcStart, 8) != 9570621661446247 || load<u16>(srcStart, 16) != 58) break;
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 18, srcEnd, dst + offsetof<this>("login"));

  //       if (load<u64>(srcStart, 0) != 28147948644859948 || load<u32>(srcStart, 8) != 3801122) break;
  //       srcStart += 12;
  ...
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 22, srcEnd, dst + offsetof<this>("node_id"));

  //       if (load<u64>(srcStart, 0) != 33214463865913388 || load<u64>(srcStart, 8) != 32088563964444769 || load<u64>(srcStart, 16) != 30399787118690399 || load<u32>(srcStart, 24) != 3801122) break;
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 28, srcEnd, dst + offsetof<this>("avatar_url"));

  //       if (load<u64>(srcStart, 0) != 32088589728874540 || load<u64>(srcStart, 8) != 32651513917997153 || load<u64>(srcStart, 16) != 29555280583983201 || load<u32>(srcStart, 24) != 2228324 || load<u16>(srcStart, 28) != 58) break;
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 30, srcEnd, dst + offsetof<this>("gravatar_id"));

  //       if (load<u64>(srcStart, 0) != 32088649858416684 || load<u32>(srcStart, 8) != 2228332 || load<u16>(srcStart, 12) != 58) break;
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 14, srcEnd, dst + offsetof<this>("url"));
  ...
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 24, srcEnd, dst + offsetof<this>("html_url"));

  //       if (load<u64>(srcStart, 0) != 31244160503775276 || load<u64>(srcStart, 8) != 33495998977015916 || load<u64>(srcStart, 16) != 26740616716222565 || load<u64>(srcStart, 24) != 9570613072101493 || load<u16>(srcStart, 32) != 58) break;
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 34, srcEnd, dst + offsetof<this>("followers_url"));

  //       if (load<u64>(srcStart, 0) != 31244160503775276 || load<u64>(srcStart, 8) != 33495998977015916 || load<u64>(srcStart, 16) != 26740565176352873 || load<u64>(srcStart, 24) != 9570613072101493 || load<u16>(srcStart, 32) != 58) break;
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 34, srcEnd, dst + offsetof<this>("following_url"));

  //       if (load<u64>(srcStart, 0) != 29555314938478636 || load<u64>(srcStart, 8) != 26740616716353651 || load<u64>(srcStart, 16) != 9570613072101493 || load<u16>(srcStart, 24) != 58) break;
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("gists_url"));

  //       if (load<u64>(srcStart, 0) != 32651591221903404 || load<u64>(srcStart, 8) != 28429462281519201 || load<u64>(srcStart, 16) != 32088649862414436 || load<u32>(srcStart, 24) != 2228332 || load<u16>(srcStart, 28) != 58) break;
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 30, srcEnd, dst + offsetof<this>("starred_url"));

  //       if (load<u64>(srcStart, 0) != 32933066198614060 || load<u64>(srcStart, 8) != 32088572554313826 || load<u64>(srcStart, 16) != 29555370778165353 || load<u64>(srcStart, 24) != 26740616715960431 || load<u64>(srcStart, 32) != 9570613072101493 || load<u16>(srcStart, 40) != 58) break;
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 42, srcEnd, dst + offsetof<this>("subscriptions_url"));

  //       if (load<u64>(srcStart, 0) != 32088624088612908 || load<u64>(srcStart, 8) != 29555345007378535 || load<u64>(srcStart, 16) != 29555370777182330 || load<u64>(srcStart, 24) != 26740616715960431 || load<u64>(srcStart, 32) != 9570613072101493 || load<u16>(srcStart, 40) != 58) break;
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 42, srcEnd, dst + offsetof<this>("organizations_url"));

  //       if (load<u64>(srcStart, 0) != 28429462276276268 || load<u64>(srcStart, 8) != 26740616716025968 || load<u64>(srcStart, 16) != 9570613072101493 || load<u16>(srcStart, 24) != 58) break;
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("repos_url"));
  ...
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 28, srcEnd, dst + offsetof<this>("events_url"));

  //       if (load<u64>(srcStart, 0) != 28429462276276268 || load<u64>(srcStart, 8) != 33214498230042723 || load<u64>(srcStart, 16) != 28429380676223077 || load<u64>(srcStart, 24) != 32651569751457910 || load<u64>(srcStart, 32) != 32088649862414451 || load<u32>(srcStart, 40) != 2228332 || load<u16>(srcStart, 44) != 58) break;
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 46, srcEnd, dst + offsetof<this>("received_events_url"));

  //       if (load<u64>(srcStart, 0) != 34058970400423980 || load<u64>(srcStart, 8) != 16325694684725360) break;
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 16, srcEnd, dst + offsetof<this>("type"));

  //       if (load<u64>(srcStart, 0) != 32370124835127340 || load<u64>(srcStart, 8) != 33214455281221733 || load<u64>(srcStart, 16) != 26740633895239785 || load<u64>(srcStart, 24) != 28429453692043380 || load<u32>(srcStart, 32) != 3801122) break;
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 36, srcEnd, dst + offsetof<this>("user_view_type"));

  //       if (load<u64>(srcStart, 0) != 29555366478086188 || load<u64>(srcStart, 8) != 27303480769446004 || load<u64>(srcStart, 16) != 30962698416881764 || load<u32>(srcStart, 24) != 3801122) break;
  //       srcStart += 28;
  //       srcStart = parseBoolField(srcStart, dst + offsetof<this>("site_admin"));
...
class RepoLicense {
  ...
  //     do {
  //       if (load<u64>(srcStart, 0) != 28429423626748011 || load<u16>(srcStart, 8) != 58) break;
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 10, srcEnd, dst + offsetof<this>("key"));

  //       if (load<u64>(srcStart, 0) != 27303545189564460 || load<u64>(srcStart, 8) != 16325694684725357) break;
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 16, srcEnd, dst + offsetof<this>("name"));

  //       if (load<u64>(srcStart, 0) != 31244224933855388 || load<u64>(srcStart, 8) != 7084396 || load<u16>(srcStart, 12) != 58) break;
  //       srcStart = deserializeStringField_SWAR<string>(srcStart + 14, srcEnd, dst + offsetof<this>("spdx_id"));

  //       if (load<u64>(srcStart, 0) != 32088649858416684 || load<u32>(srcStart, 8) != 2228332 || load<u16>(srcStart, 12) != 58) break;
  //       srcStart += 14;
  //       srcStart = deserializeNullableStringField(srcStart, srcEnd, dst + offsetof<this>("url"));
...
class Repo {
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("full_name"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("forks_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 24, srcEnd, dst + offsetof<this>("keys_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 42, srcEnd, dst + offsetof<this>("collaborators_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("teams_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("hooks_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 40, srcEnd, dst + offsetof<this>("issue_events_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 34, srcEnd, dst + offsetof<this>("assignees_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 32, srcEnd, dst + offsetof<this>("branches_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 24, srcEnd, dst + offsetof<this>("tags_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("blobs_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 32, srcEnd, dst + offsetof<this>("git_tags_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 32, srcEnd, dst + offsetof<this>("git_refs_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("trees_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 32, srcEnd, dst + offsetof<this>("statuses_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 34, srcEnd, dst + offsetof<this>("languages_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 36, srcEnd, dst + offsetof<this>("stargazers_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 40, srcEnd, dst + offsetof<this>("contributors_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 38, srcEnd, dst + offsetof<this>("subscribers_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 40, srcEnd, dst + offsetof<this>("subscription_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 30, srcEnd, dst + offsetof<this>("commits_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 38, srcEnd, dst + offsetof<this>("git_commits_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 32, srcEnd, dst + offsetof<this>("comments_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 42, srcEnd, dst + offsetof<this>("issue_comment_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 32, srcEnd, dst + offsetof<this>("contents_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 30, srcEnd, dst + offsetof<this>("compare_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 28, srcEnd, dst + offsetof<this>("merges_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 30, srcEnd, dst + offsetof<this>("archive_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 34, srcEnd, dst + offsetof<this>("downloads_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 28, srcEnd, dst + offsetof<this>("issues_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("pulls_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 36, srcEnd, dst + offsetof<this>("milestones_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 42, srcEnd, dst + offsetof<this>("notifications_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 28, srcEnd, dst + offsetof<this>("labels_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 32, srcEnd, dst + offsetof<this>("releases_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 38, srcEnd, dst + offsetof<this>("deployments_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 28, srcEnd, dst + offsetof<this>("created_at"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 28, srcEnd, dst + offsetof<this>("updated_at"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("pushed_at"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 22, srcEnd, dst + offsetof<this>("git_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 22, srcEnd, dst + offsetof<this>("ssh_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("clone_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 22, srcEnd, dst + offsetof<this>("svn_url"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 28, srcEnd, dst + offsetof<this>("visibility"));
  ...
  //     srcStart = deserializeStringField_SWAR<string>(srcStart + 36, srcEnd, dst + offsetof<this>("default_branch"));
