...
class Repo {
  ...
  __DESERIALIZE<__JSON_T>(srcStart: usize, srcEnd: usize, out: __JSON_T): usize {
    ...
    do {
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 22, srcEnd, dst + offsetof<this>("node_id"));

      if (load<u64>(srcStart, 0) != 27303545189564460 || load<u64>(srcStart, 8) != 16325694684725357) break;
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 16, srcEnd, dst + offsetof<this>("name"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("full_name"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 24, srcEnd, dst + offsetof<this>("html_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 14, srcEnd, dst + offsetof<this>("url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("forks_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 24, srcEnd, dst + offsetof<this>("keys_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 42, srcEnd, dst + offsetof<this>("collaborators_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("teams_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("hooks_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 40, srcEnd, dst + offsetof<this>("issue_events_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 28, srcEnd, dst + offsetof<this>("events_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 34, srcEnd, dst + offsetof<this>("assignees_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 32, srcEnd, dst + offsetof<this>("branches_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 24, srcEnd, dst + offsetof<this>("tags_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("blobs_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 32, srcEnd, dst + offsetof<this>("git_tags_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 32, srcEnd, dst + offsetof<this>("git_refs_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("trees_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 32, srcEnd, dst + offsetof<this>("statuses_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 34, srcEnd, dst + offsetof<this>("languages_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 36, srcEnd, dst + offsetof<this>("stargazers_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 40, srcEnd, dst + offsetof<this>("contributors_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 38, srcEnd, dst + offsetof<this>("subscribers_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 40, srcEnd, dst + offsetof<this>("subscription_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 30, srcEnd, dst + offsetof<this>("commits_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 38, srcEnd, dst + offsetof<this>("git_commits_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 32, srcEnd, dst + offsetof<this>("comments_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 42, srcEnd, dst + offsetof<this>("issue_comment_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 32, srcEnd, dst + offsetof<this>("contents_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 30, srcEnd, dst + offsetof<this>("compare_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 28, srcEnd, dst + offsetof<this>("merges_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 30, srcEnd, dst + offsetof<this>("archive_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 34, srcEnd, dst + offsetof<this>("downloads_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 28, srcEnd, dst + offsetof<this>("issues_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("pulls_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 36, srcEnd, dst + offsetof<this>("milestones_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 42, srcEnd, dst + offsetof<this>("notifications_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 28, srcEnd, dst + offsetof<this>("labels_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 32, srcEnd, dst + offsetof<this>("releases_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 38, srcEnd, dst + offsetof<this>("deployments_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 28, srcEnd, dst + offsetof<this>("created_at"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 28, srcEnd, dst + offsetof<this>("updated_at"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("pushed_at"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 22, srcEnd, dst + offsetof<this>("git_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 22, srcEnd, dst + offsetof<this>("ssh_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 26, srcEnd, dst + offsetof<this>("clone_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 22, srcEnd, dst + offsetof<this>("svn_url"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 28, srcEnd, dst + offsetof<this>("visibility"));
      ...
      srcStart = deserializeStringToField_SWAR<string>(srcStart + 36, srcEnd, dst + offsetof<this>("default_branch"));
