...
// Typed @json structs matching repo.data.ts (REPO), lifted verbatim from
// assembly/__benches__/large.bench.ts. Fields are in JSON order so JSON.parse<Repo>
// takes the eager fast path. Used as the *typed* baseline for the repo bench.
