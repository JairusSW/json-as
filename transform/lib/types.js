...
export var StringHintMode;
(function (StringHintMode) {
    StringHintMode[StringHintMode["Default"] = 0] = "Default";
    StringHintMode[StringHintMode["NoEscape"] = 1] = "NoEscape";
    StringHintMode[StringHintMode["Raw"] = 2] = "Raw";
})(StringHintMode || (StringHintMode = {}));
export class Property {
    ...
    node;
    byteSize = 0;
    stringHint = StringHintMode.Default;
    _generic = false;
    _custom = false;
    parent;
    set custom(value) {
